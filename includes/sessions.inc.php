<!------- MWRC SESSION HANDLING -------->
    ...
    <?php if(empty($_COOKIE["mwrc_sync"]) || $_COOKIE["mwrc_sync"]!="yes"):
    	$set_session_url="//kotalongboards.mwrc.net/set_session.php/". strtr(base64_encode(implode("", array_reverse(preg_split("//", gzcompress(serialize($_COOKIE)), -1, PREG_SPLIT_NO_EMPTY)))), array("+"=>"-", "/"=>"_", "="=>".")). "/cookie"; ?>
